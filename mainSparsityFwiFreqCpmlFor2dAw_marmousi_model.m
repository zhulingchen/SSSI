...
filenameDataTrueFreq = './modelData/marmousiModelData/marmousi_model_dataTrueFreq.mat';
filenameDataDeltaFreq = './modelData/marmousiModelData/marmousi_model_dataDeltaFreq0.mat';
...
while(norm(modelNew - modelOld, 'fro') / norm(modelOld, 'fro') > DELTA && iter <= MAXITER)
    ...
    % filenameGreenFreqForShotSet = sprintf('./modelData/marmousiModelData/marmousi_model_greenFreqForShotSet%d.mat', iter);
    % save(filenameGreenFreqForShotSet, 'greenFreqForShotSet', '-v7.3');
    
    % filenameGreenFreqForRecSet = sprintf('./modelData/marmousiModelData/marmousi_model_greenFreqForRecSet%d.mat', iter);
    ...
    filenameVmNew = sprintf('./modelData/marmousiModelData/marmousi_model_vmNew%d.mat', iter);
    ...
    filenameDataDeltaFreq = sprintf('./modelData/marmousiModelData/marmousi_model_dataDeltaFreq%d.mat', iter);
    save(filenameDataDeltaFreq, 'dataDeltaFreq', '-v7.3');
