...
filenameDataTrueFreq = './modelData/faultModelData/fault_model_dataTrueFreq.mat';
filenameDataDeltaFreq = './modelData/faultModelData/fault_model_dataDeltaFreq0.mat';
...
while(norm(modelNew - modelOld, 'fro') / norm(modelOld, 'fro') > DELTA && iter <= MAXITER)
    ...
    % filenameGreenFreqForShotSet = sprintf('./modelData/faultModelData/fault_model_greenFreqForShotSet%d.mat', iter);
    % save(filenameGreenFreqForShotSet, 'greenFreqForShotSet', '-v7.3');
    
    % filenameGreenFreqForRecSet = sprintf('./modelData/faultModelData/fault_model_greenFreqForRecSet%d.mat', iter);
    ...
    filenameVmNew = sprintf('./modelData/faultModelData/fault_model_vmNew%d.mat', iter);
    ...
    filenameDataDeltaFreq = sprintf('./modelData/faultModelData/fault_model_dataDeltaFreq%d.mat', iter);
    save(filenameDataDeltaFreq, 'dataDeltaFreq', '-v7.3');
