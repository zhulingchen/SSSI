...
load('./modelData/marmousiModelData/velocityModelMarmousi.mat'); % velocityModel
...
load('./modelData/marmousiModelData/velocityModelMarmousiSmooth.mat'); % velocityModelSmooth
...
filenameVideoModelShots = './videos/marmousi_ModelShots.mp4';
...
for ixs = 1:nShots %21:nx+20 % shot loop
    ...
    filenameDataTrue = sprintf('./modelData/marmousiModelData/marmousi_dataTrue%d.mat', xs-nBoundary);
    filenameDataSmooth = sprintf('./modelData/marmousiModelData/marmousi_dataSmooth%d.mat', xs-nBoundary);
    filenameSnapshotSmooth = sprintf('./modelData/marmousiModelData/marmousi_snapshotSmooth%d.mat', xs-nBoundary);
...
filenameVideoModelTravelTime = './videos/marmousi_ModelTravelTime.mp4';
...
filenameTravelTime = './modelData/marmousiModelData/marmousi_travelTime.mat';
...
filenameVideoModelKirchhoff = './videos/marmousi_ModelKirchhoff.mp4';
...
for ixs = 1:nShots
    ...
    load(sprintf('./modelData/marmousiModelData/marmousi_dataTrue%d.mat', xs)); % data
    dataTrue = dataTrue(nBoundary+1:end-nBoundary, :)';
    tic;
...
filenameKirchoffMigStackedMat = './modelData/marmousiModelData/marmousi_KirchoffMigStacked.mat';
...
filenameVideoModelRTM = './videos/marmousi_ModelRTM.mp4';
...
for ixs = 1:nShots      %1:nx
    ...
    load(sprintf('./modelData/marmousiModelData/marmousi_dataTrue%d.mat', xs)); % dataTrue
    load(sprintf('./modelData/marmousiModelData/marmousi_dataSmooth%d.mat', xs)); % dataSmooth
    ...
    filenameRTMSnapshot = sprintf('./modelData/marmousiModelData/marmousi_rtmsnapshot%d.mat', xs);
    
    if ~exist(filenameRTMSnapshot, 'file')
        save(filenameRTMSnapshot,'rtmsnapshot', '-v7.3');
    end
    
    load(sprintf('./modelData/marmousiModelData/marmousi_snapshotSmooth%d.mat', xs)); % snapshotSmooth
...
filenameStackedRtmMat = './modelData/marmousiModelData/marmousi_StackedRTM.mat';
