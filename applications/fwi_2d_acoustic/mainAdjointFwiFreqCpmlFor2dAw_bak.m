% MAINADJOINTFWIFREQCPMLFOR2DAW simulates the full waveform inversion (FWI)
% with 2-d acoustic wave in frequency domain based on the CPML absorbing
% boundary condition, using the adjoint-state method
%
