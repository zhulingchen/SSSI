function T = eikonal3dPar(V, dx, sz, sx, sy, iMax)
...
% Note: this implementation requires at least 8 local workers !!! This
% code only parallelize the ordering of sweepings. No domain decomposition.
