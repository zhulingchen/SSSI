disp(' ');
disp(['fdct_wrapping_demo_basic.m -- This demo displays a curvelet'])
...
% fdct_wrapping_demo_basic.m -- This demo displays a curvelet both in the spatial and frequency domains.
