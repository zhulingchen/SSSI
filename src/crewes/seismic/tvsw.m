function trout=tvsw(trin,t,aec_length,flow,fhigh,nfilt)
% trout=tvsw(trin,t,aec_length,flow,fhigh,nfilt)
% 
% tvsw does time variant spectral whitening.
% A set of gaussian filters are
