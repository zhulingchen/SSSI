function PI_OpenFile(smat,t,dist)
ylbl='Samples';
xlbl='Columns';
if(nargin<=1)
    t=[];
...
global SCALE_OPT AMPFLAG NUMBER_OF_COLORS GRAY_PCT CLIP COLOR_MAP NOBRIGHTEN PICKS PICKCOLOR XAXISTOP IMCONTROLS ZOOM_VALUE ZOOM_LOCKS
global SEISMAT
...
try
    ...
    set(hmaster,'userdata',[mxs smean stddev],'value',ampflag,'backgroundcolor',[.8314 .8157 .7843]);
