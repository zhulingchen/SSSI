function [seis,t]=afd_explode_alt(dx,dtstep,dt,tmax, ...
         velocity,xrec,zrec,w,tw,laplacian,boundary,zmin)
% AFD_EXPLODE_ALT ... makes exploding reflector models with wavelet injection
%
% [seis,t]=afd_explode_alt(dx,dtstep,dt,tmax,velocity,xrec,zrec,w,tw,laplacian,boundary)
%
