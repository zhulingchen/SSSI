...
%
% NEWLINE dose not include the ability to modify the created lines in any way. For
...
%
% NEWLINE is intended to be incorporated within larger tools with specific 
...
if( strcmp(action,'buttondown') )
	...
	if(new&button==2)
		set(gcf,'windowbuttonupfcn','newline(''kill'')');
	elseif(~new&button==2)
		set(gcf,'windowbuttonupfcn','newline(''poly'')');
	elseif(new&button==3)
		set(gcf,'windowbuttonupfcn','newline(''duplicate'')');
	elseif(~new&button==3)
		set(gcf,'windowbuttonupfcn','newline(''fini'')');
	else
		set(gcf,'windowbuttonupfcn','newline(''draw'')');
	end
	return
end
