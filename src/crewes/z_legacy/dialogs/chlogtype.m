...
if( strcmp(action,'init'))
	...
	ynow=ynow-height-sep;
	width=150;
	hloglbl=uicontrol('style','text','string','Log name:','position',...
	...
	ynow=ynow-height-sep;
	width=150;
	hnewtypelbl=uicontrol('style','text','string','New type ->'...
...
if(strcmp(action,'fini'))
	...
	ret1=setstr(info(1:ind(1)-1));
	ret2=setstr(info(ind(1)+1:ind(2)-1));
	ret3=info(ind(2)+1);
