...
int template_matching(double *cost, double *number_of_predictions_per_feature_point, double *unreliable_template, double *input, double *input_label, double *template, double *template_label, int ext_length, double *feature_location_x, double *feature_location_y, int number_of_feature_points_per_row, int shift_y, int window_size_x, int window_size_y, int rows, int cols);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    double *input, *input_label;
    double *template, *template_label;
    ...
    template = mxGetPr(prhs[2]);   
    template_label = mxGetPr(prhs[3]);
    
	ext_length = (int)(*mxGetPr(prhs[4]));
    
	feature_location_x = mxGetPr(prhs[5]);
	feature_location_y = mxGetPr(prhs[6]);
	...
	shift_y = (int)(*mxGetPr(prhs[7]));

    
    
	window_size_x = (int)(*mxGetPr(prhs[8]));
    window_size_y = (int)(*mxGetPr(prhs[9]));
    ...
    template_matching(cost, number_of_predictions_per_feature_point, unreliable_template, input, input_label, template, template_label, ext_length, feature_location_x, feature_location_y, number_of_feature_points_per_row, shift_y, window_size_x, window_size_y, rows, cols);
}
