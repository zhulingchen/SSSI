...
filenameVideoModelRTM = './videos/fault_ModelRTM.mp4';
...
for ixs = 1:nShots      %1:nx
    ...
    load(sprintf('./modelData/faultModelData/fault_dataTrue%d.mat', xs)); % dataTrue
    load(sprintf('./modelData/faultModelData/fault_dataSmooth%d.mat', xs)); % dataSmooth
    ...
    filenameRTMSnapshot = sprintf('./modelData/faultModelData/fault_rtmsnapshot%d.mat', xs);
    
    if ~exist(filenameRTMSnapshot, 'file')
        save(filenameRTMSnapshot,'rtmsnapshot', '-v7.3');
    end
    
    load(sprintf('./modelData/faultModelData/fault_snapshotSmooth%d.mat', xs)); % snapshotSmooth
...
filenameStackedRtmMat = './modelData/faultModelData/fault_StackedRTM.mat';
